...
class NTXentLoss(nn.Module):
    def __init__(
        self, temperature: float = 0.5, gather_distributed: bool = False, dim_norm=False
    ):
    ...
    def forward(self, model, images, online_labels=None):
        ...
        online_prob_loss_acc = accuracy(cls, online_labels)[0]
        ...
        #     denom = (
        #         full_rank_z.norm(p=2, dim=0, keepdim=True)
        #         .clamp_min(1e-12)
        #         .expand_as(z_0)
        #     )
