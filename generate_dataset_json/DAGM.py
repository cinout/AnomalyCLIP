    ...
    def run(self):
        ...
        for cls_name in self.CLSNAMES:
            ...
            for phase in ["Train", "Test"]:
                ...
                img_normal_fpath_list = list(
                    set(img_fpath_list) - set(img_exclude_list)
                )
                ...
                mask_names_none.extend(
                    [None] * len(img_normal_fpath_list) + gt_fpath_list
                )
                ...
                for idx, img_name in enumerate(x):
                    info_img = dict(
                        ...
                        mask_path=(
                            f"{cls_name}/{phase}/Label/{mask_names_none[idx]}"
                            if mask_names_none[idx] != None
                            else ""
                        ),
                        cls_name=cls_name,
                        specie_name="",
